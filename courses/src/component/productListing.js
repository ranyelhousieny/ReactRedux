...
const ProductList = (props) => {
    ...
    const renderList = ({prodlist}) => {
        ...
        if ( prodlist ) {
            console.log("ProdList inside if", prodlist)
                ...
                <Link key={data.id} to={`/product/${data.id}`} >
                    <div className="card col-md-3">
                        <div class="row">
                            ...
                            <hr/>
                            <span class="topTemp">Class Name: {data.name}</span>
                            </div>
                            <div class="card-body">
                            <span class="max">Tuition: ${data.price}</span>  
                                <h4 class="card-title">{data.type}</h4>
                                <p class="card-text">
                                    <p class="day">{data.description}</p>
                                </p>
                        </div>
                    </div>
                </Link>
